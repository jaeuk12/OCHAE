<?php /* Template_ 2.2.3 2016/04/02 12:43:02 /home/hosting_users/ochae/www/_template/content/admin/author/list.html */
$TPL_rows_1=empty($TPL_VAR["rows"])||!is_array($TPL_VAR["rows"])?0:count($TPL_VAR["rows"]);?>
<script>
    $(document).ready(function(){
    	$("#author_list tr").click(function(){
...
<?php if($TPL_VAR["search_keyword"]!=""){?>$("#search_keyword").val("<?php echo $TPL_VAR["search_keyword"]?>");<?php }?>
	...
	function addAuthor(idx){
		...
		if(idx == ""){
			document.location.href = "/admin/author/add?"+retUrl;
		}
		else{
			document.location.href = "/admin/author/add?"+retUrl+"&idx="+idx;
		}
	}
</script>
...
<button type="button" class="tiny" onclick="addAuthor();">작가추가</button>
<table>
	<thead>
		<tr>
			<th>No.</th>
	...
	<tfoot>
		...
		<tr>
			<td colspan="3" align="center">
				<form name="searchForm" id="searchForm" action="/admin/author/list" method="get">
					<div class="row">
